...
output_dir = os.path.join(script_dir, "HT_b")
...
for i, inputFile in enumerate(inputFiles):
    ...
    histogram_HT = ROOT.TH1F("hist_ht", "H_{T}(light-quarks-jets) ; H_{T}(light-quarks-jets) (GeV); Number of events (L = 200 fb^{-1})" , 80, 0, 3000)
