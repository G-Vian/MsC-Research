...
colors =  [ ROOT.kMagenta, ROOT.kOrange+4, ROOT.kBlue,  ROOT.kGreen+1, ROOT.kBlack, ROOT.kGray, ROOT.kCyan,  ROOT.kRed ]# ROOT.kGreen+1, ROOT.kOrange+4, ROOT.kViolet+5, ROOT.kAzure-7]
