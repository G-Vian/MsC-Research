...
for i, inputFile in enumerate(inputFiles):
    ...
    hist1 = ROOT.TH1F("hist1", "Invariant mass of W[1]", 50, 60, 100)
    hist2 = ROOT.TH1F("hist2", "Invariant mass of W[2]", 50, 60, 100)
...
output_file_path_1 = os.path.join(output_dir, "mW1_nfill.png")
...
canvas_2.Update()
# Salvando o histograma em um arquivo de imagem
output_file_path_2 = os.path.join(output_dir, "mW2_nfill.png")
