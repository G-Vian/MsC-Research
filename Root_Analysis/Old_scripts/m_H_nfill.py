...
for i, inputFile in enumerate(inputFiles):
    ...
    hist1 = ROOT.TH1F("hist1", "Invariant mass of h[1]", 50, 70, 170)
    hist2 = ROOT.TH1F("hist2", "Invariant mass of h[2]", 50, 70, 170)
...
output_file_path_1 = os.path.join(output_dir, "mh1_Nfill.png")
...
for i, hist2 in enumerate(histograms_2):
   ...
   # Ativando escala logarítmica no eixo Y riando legenda personalizada
    legend_PT = ROOT.TLegend(0.85, 1.02 - 0.12 * i, 0.92, 0.83 - 0.12 * i)
    legend_PT.SetTextSize(0.02)
    legend_PT.SetEntrySeparation(0.0005)
    legend_PT.SetBorderSize(0)
...
canvas_2.Update()
# Salvando o histograma em um arquivo de imagem
output_file_path_2 = os.path.join(output_dir, "mh2_Nfill.png")
