...
#    peso_atual = 1/10000 #prescrição de normalização surgerida pelo Ricardo
####NAO DÁ CERTO!
    peso_atual=1
...
# Calculando média e desvio padrão 
    ...
    # Iterar sobre todos os bins do histograma70
...
#    hist1.SetMinimum(y_min)
#    hist1.GetXaxis().SetRangeUser(95, 145) #Isso define o intervalo de visualização do eixo x de 20 a 80, sem alterar a binagem do histograma.



for hist2 in histograms_2:
    hist2.SetMaximum(max_y_2 * margin_factor)
 #   hist2.SetMinimum(y_min)
#    hist2.GetXaxis().SetRangeUser(20, 80)  #Isso define o intervalo de visualização do eixo x de 20 a 80, sem alterar a binagem do histograma.
...
for i, hist1 in enumerate(histograms_1):
    ...
    hist1.Draw("SAME")
  #  canvas_1.SetLogy()  # Ativando escala logarítmica no eixo Y
...
output_file_path_1 = os.path.join(output_dir, "mh1_N_fill_norm.png")
...
for i, hist2 in enumerate(histograms_2):
    ...
    hist2.Sumw2(0)
   # canvas_2.SetLogy()  # Ativando escala logarítmica no eixo Y
...
canvas_2.Update()
# Salvando o histograma em um arquivo de imagem
output_file_path_2 = os.path.join(output_dir, "mh2_N_fill_norm.png")
