...
colors =  [ ROOT.kMagenta, ROOT.kOrange+4, ROOT.kBlue,  ROOT.kGreen+1, ROOT.kBlack, ROOT.kGray, ROOT.kCyan,  ROOT.kRed ]
for i, inputFile in enumerate(inputFiles):
    ...
    histogram_PT = ROOT.TH1F(f"hist_pt_{i}", "#Delta R jb[4] and jb[6]; #Delta R ; Number of events", 40, 0, 9)
    # histogram_ETA = ROOT.TH1F(f"hist_eta_{i}", "#eta jb[1]; #eta ; Number of events", 40, -10, 10)
...
for i, inputFile in enumerate(inputFiles):
    ...
    # Criando histogramas para PT e ETA dos jato b
    histogram_PT = ROOT.TH1F(f"hist_pt_{i}", "#Delta R jb[5] and jb[6]; #Delta R ; Number of events", 40, 0, 9)
    # histogram_ETA = ROOT.TH1F(f"hist_eta_{i}", "#eta jb[1]; #eta ; Number of events", 40, -10, 10)
