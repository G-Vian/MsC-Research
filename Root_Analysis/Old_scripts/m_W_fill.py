...
for i, inputFile in enumerate(inputFiles):
    ...
    hist1 = ROOT.TH1F("hist1", "Invariant mass of W[1];  M_{j_{q} j_{q}} (GeV); Number of events (L = 200 fb^{-1})", 70, 50, 120)
    hist2 = ROOT.TH1F("hist2", "Invariant mass of W[2];  M_{j_{q} j_{q}} (GeV); Number of events (L = 200 fb^{-1})", 70, 50, 120)
...
# Itere sobre os histogramas em ambas as listas
for histogram_list in [histograms_1, histograms_2]:
...
output_file_path_1 = os.path.join(output_dir, "mW1_fill.png")
...
canvas_2.Update()
# Salvando o histograma em um arquivo de imagem
output_file_path_2 = os.path.join(output_dir, "mW2_fill.png")
