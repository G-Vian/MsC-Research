...
for i, inputFile in enumerate(inputFiles):
    ...
    hist1 = ROOT.TH1F("hist1", "Invariant mass of h[1];  M_{j_{b} j_{b}} (GeV); Number of events (L = 200 fb^{-1}) ", 70, 70, 170)
    hist2 = ROOT.TH1F("hist2", "Invariant mass of h[2];  M_{j_{b} j_{b}} (GeV); Number of events (L = 200 fb^{-1})", 70, 70, 170)
...
#        additional_jets = [jet for jet in branchJet if abs(jet.Flavor) == 5 and 25 <= jet.PT < 35 and abs(jet.Eta) <= 2.5]
...
output_file_path_1 = os.path.join(output_dir, "mh1_fill.png")
...
# Salvando o histograma em um arquivo de imagem
output_file_path_2 = os.path.join(output_dir, "mh2_fill.png")
