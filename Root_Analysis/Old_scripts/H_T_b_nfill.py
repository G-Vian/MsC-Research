...
output_dir = os.path.join(script_dir, "HT_bnfill")
...
for i, inputFile in enumerate(inputFiles):
    ...
    histogram_HT = ROOT.TH1F("hist_ht", "H_{T}(b-quarks-jets) ; H_{T}(b-quarks-jets) (GeV); Number of events (L = 200 fb^{-1})" , 80, 0, 5000)
