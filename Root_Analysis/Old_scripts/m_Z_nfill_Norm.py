...
for i, inputFile in enumerate(inputFiles):
    ...
    # Histogramas globais para todos os eventos
    hist1 = ROOT.TH1F("hist1", "Invariant mass of Z[1];  M_{j_{q} j_{q}} (GeV); Number of events (Normalized to one)", 70, 60, 120)
    hist2 = ROOT.TH1F("hist2", "Invariant mass of Z[2];  M_{j_{q} j_{q}} (GeV); Number of events (Normalized to one)", 70, 60, 120)
...
output_file_path_1 = os.path.join(output_dir, "mz1_N_fill_norm.png")
...
canvas_2.Update()
# Salvando o histograma em um arquivo de imagem
output_file_path_2 = os.path.join(output_dir, "mz2_N_fill_norm.png")
