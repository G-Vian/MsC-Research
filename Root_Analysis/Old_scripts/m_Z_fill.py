...
for i, inputFile in enumerate(inputFiles):
    ...
    hist1 = ROOT.TH1F("hist1", "Invariant mass of Z[1];  M_{j_{b} j_{b}} (GeV); Number of events (L = 200 fb^{-1})", 70, 75, 120)
    hist2 = ROOT.TH1F("hist2", "Invariant mass of Z[2];  M_{j_{b} j_{b}} (GeV); Number of events (L = 200 fb^{-1})", 70, 75, 120)
...
output_file_path_1 = os.path.join(output_dir, "mZ1_fill.png")
...
canvas_2.Update()
# Salvando o histograma em um arquivo de imagem
output_file_path_2 = os.path.join(output_dir, "mZ2_fill.png")
