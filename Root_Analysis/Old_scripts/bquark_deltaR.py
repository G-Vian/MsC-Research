...
lista_de_pesos = [P_1, P_2, P_4, P_5, P_6, P_8, P_9, P_7]
...
for i, inputFile in enumerate(inputFiles):
    ...
    histogram_PT = ROOT.TH1F(f"hist_pt_{i}", "#Delta R b[1] and b[2]; #Delta R ; Number of events (L = 200 fb^{-1})", 40, 0, 9)
    # histogram_ETA = ROOT.TH1F(f"hist_eta_{i}", "#eta b[1]; #eta ; Number of events (L = 200 fb^{-1})", 40, -10, 10)
    ...
    for entry in range(numberOfEntries):
        ...
        jets = treeReader.UseBranch("Particle")
        ...
        for jet in jets:
            ...
            if abs(jet.Flavor) == 5 and jet.PT >= 30 and abs(jet.Eta) <= 2.5:
                pt_b.append(jet.PT)
...
colors = [ ROOT.kMagenta, ROOT.kBlue,  ROOT.kGreen+1, ROOT.kBlack, ROOT.kGray, ROOT.kCyan,  ROOT.kRed ]# ROOT.kGreen+1, ROOT.kOrange+4, ROOT.kViolet+5, ROOT.kAzure-7]
...
for i, inputFile in enumerate(inputFiles):
    ...
    # Criando histogramas para PT e ETA dos jato b
    histogram_PT = ROOT.TH1F(f"hist_pt_{i}", "#Delta R b[3] and b[4]; #Delta R ; Number of events (L = 200 fb^{-1})", 40, 0, 9)
    # histogram_ETA = ROOT.TH1F(f"hist_eta_{i}", "#eta b[1]; #eta ; Number of events (L = 200 fb^{-1})", 40, -10, 10)
...
for i, inputFile in enumerate(inputFiles):
    ...
    # Criando histogramas para PT e ETA dos jato b
    histogram_PT = ROOT.TH1F(f"hist_pt_{i}", "#Delta R b[1] and b[3]; #Delta R ; Number of events (L = 200 fb^{-1})", 40, 0, 9)
    # histogram_ETA = ROOT.TH1F(f"hist_eta_{i}", "#eta b[1]; #eta ; Number of events (L = 200 fb^{-1})", 40, -10, 10)
...
for i, inputFile in enumerate(inputFiles):
    ...
    # Criando histogramas para PT e ETA dos jato b
    histogram_PT = ROOT.TH1F(f"hist_pt_{i}", "#Delta R b[1] and b[4]; #Delta R ; Number of events (L = 200 fb^{-1})", 40, 0, 9)
    # histogram_ETA = ROOT.TH1F(f"hist_eta_{i}", "#eta b[1]; #eta ; Number of events (L = 200 fb^{-1})", 40, -10, 10)
...
for i, inputFile in enumerate(inputFiles):
    ...
    # Criando histogramas para PT e ETA dos jato b
    histogram_PT = ROOT.TH1F(f"hist_pt_{i}", "#Delta R b[2] and b[3]; #Delta R ; Number of events (L = 200 fb^{-1})", 40, 0, 9)
    # histogram_ETA = ROOT.TH1F(f"hist_eta_{i}", "#eta b[1]; #eta ; Number of events (L = 200 fb^{-1})", 40, -10, 10)
...
for i, inputFile in enumerate(inputFiles):
    ...
    # Criando histogramas para PT e ETA dos jato b
    histogram_PT = ROOT.TH1F(f"hist_pt_{i}", "#Delta R b[2] and b[4]; #Delta R ; Number of events (L = 200 fb^{-1})", 40, 0, 9)
    # histogram_ETA = ROOT.TH1F(f"hist_eta_{i}", "#eta b[1]; #eta ; Number of events (L = 200 fb^{-1})", 40, -10, 10)
...
for i, inputFile in enumerate(inputFiles):
    ...
    # Criando histogramas para PT e ETA dos jato b
    histogram_PT = ROOT.TH1F(f"hist_pt_{i}", "#Delta R b[1] and b[5]; #Delta R ; Number of events (L = 200 fb^{-1})", 40, 0, 9)
    # histogram_ETA = ROOT.TH1F(f"hist_eta_{i}", "#eta b[1]; #eta ; Number of events (L = 200 fb^{-1})", 40, -10, 10)
...
for i, inputFile in enumerate(inputFiles):
    ...
    # Criando histogramas para PT e ETA dos jato b
    histogram_PT = ROOT.TH1F(f"hist_pt_{i}", "#Delta R b[1] and b[6]; #Delta R ; Number of events (L = 200 fb^{-1})", 40, 0, 9)
    # histogram_ETA = ROOT.TH1F(f"hist_eta_{i}", "#eta b[1]; #eta ; Number of events (L = 200 fb^{-1})", 40, -10, 10)
...
for i, inputFile in enumerate(inputFiles):
    ...
    # Criando histogramas para PT e ETA dos jato b
    histogram_PT = ROOT.TH1F(f"hist_pt_{i}", "#Delta R b[2] and b[5]; #Delta R ; Number of events (L = 200 fb^{-1})", 40, 0, 9)
    # histogram_ETA = ROOT.TH1F(f"hist_eta_{i}", "#eta b[1]; #eta ; Number of events (L = 200 fb^{-1})", 40, -10, 10)
...
for i, inputFile in enumerate(inputFiles):
    ...
    # Criando histogramas para PT e ETA dos jato b
    histogram_PT = ROOT.TH1F(f"hist_pt_{i}", "#Delta R b[2] and b[6]; #Delta R ; Number of events (L = 200 fb^{-1})", 40, 0, 9)
    # histogram_ETA = ROOT.TH1F(f"hist_eta_{i}", "#eta b[1]; #eta ; Number of events (L = 200 fb^{-1})", 40, -10, 10)
...
for i, inputFile in enumerate(inputFiles):
    ...
    # Criando histogramas para PT e ETA dos jato b
    histogram_PT = ROOT.TH1F(f"hist_pt_{i}", "#Delta R b[3] and b[5]; #Delta R ; Number of events (L = 200 fb^{-1})", 40, 0, 9)
    # histogram_ETA = ROOT.TH1F(f"hist_eta_{i}", "#eta b[1]; #eta ; Number of events (L = 200 fb^{-1})", 40, -10, 10)
...
for i, inputFile in enumerate(inputFiles):
    ...
    # Criando histogramas para PT e ETA dos jato b
    histogram_PT = ROOT.TH1F(f"hist_pt_{i}", "#Delta R b[4] and b[5]; #Delta R ; Number of events (L = 200 fb^{-1})", 40, 0, 9)
    # histogram_ETA = ROOT.TH1F(f"hist_eta_{i}", "#eta b[1]; #eta ; Number of events (L = 200 fb^{-1})", 40, -10, 10)
...
colors = [ ROOT.kMagenta, ROOT.kBlue,  ROOT.kGreen+1, ROOT.kBlack, ROOT.kGray, ROOT.kCyan,  ROOT.kRed ]
for i, inputFile in enumerate(inputFiles):
    print(f"Reading file {inputFile}")
    ...
    # Criando histogramas para PT e ETA dos jato b
    histogram_PT = ROOT.TH1F(f"hist_pt_{i}", "#Delta R b[4] and b[6]; #Delta R ; Number of events (L = 200 fb^{-1})", 40, 0, 9)
    # histogram_ETA = ROOT.TH1F(f"hist_eta_{i}", "#eta b[1]; #eta ; Number of events (L = 200 fb^{-1})", 40, -10, 10)
...
output_file_path_PT = os.path.join(output_dir, "deltarb4b6.png")
canvas_PT.SaveAs(output_file_path_PT)
...
output_file_path_PT = os.path.join(output_dir, "deltarb5b6.png")
canvas_PT.SaveAs(output_file_path_PT)
