...
#lista_de_pesos =  [P_4, P_12, P_13, P_11]
#colors =  [  ROOT.kBlue ,  ROOT.kBlack , ROOT.kCyan , ROOT.kRed]
...
with open(output_file_path6, "a") as output_file6:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        chain.Add(inputFile)
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} of the 6th most energetic b-quark jet; P_{T} (GeV/c); Number of events (L = 200 fb^{-1})", 5,35, 150)
        histogram_ETA = ROOT.TH1F("hist_pt", "#eta jb[6]; #eta ; Number of events (L = 200 fb^{-1})", 120, -5,5)
