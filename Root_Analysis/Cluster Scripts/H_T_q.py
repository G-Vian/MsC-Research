...
##############################################################
# Definindo pesos, pro histograma distribuir de acordo com a seção de choque:
##############################################################
...
with open(output_file_path, "a") as output_file:
    for i, inputFile in enumerate(inputFiles):
        ...
        histogram_HT = ROOT.TH1F("hist_ht", "H_{T}(light quark jets) ; H_{T}(light quark jets) (GeV); Number of events (L = 200 fb^{-1})", 35, 0, 2000)
        histogram_HT.Sumw2(0)  # Desativar incertezas
        ...
        for entry in range(numberOfEntries):
            ...
            if nJets >= 6 and HT_value > 500:
                events_passed_MET_HT_nJets += 1  # Contar quantos eventos passaram
                ...
                continue  # Se a primeira condicional não for satisfeita, vá para o próximo evento
