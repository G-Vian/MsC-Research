...
with open(output_file_path, "a") as output_file:
    ...
    # Histogramas globais para todos os eventos
        hist1 = ROOT.TH1F("hist1", "Invariant mass of Z[1];  M_{j_b j_b} (GeV); Number of events (Normalized to one)", 70, 60, 120)
        hist2 = ROOT.TH1F("hist2", "Invariant mass of Z[2];  M_{j_b j_b} (GeV); Number of events (Normalized to one)", 70, 60, 120)
