...
lista_de_pesos =  [P_1, P_3, P_5, P_6, P_2, P_4, P_7, P_8, P_12, P_10, P_13, P_11]
colors =  [  ROOT.kMagenta+3, ROOT.kOrange+4, ROOT.kGreen+3, ROOT.kAzure+3,  ROOT.kMagenta,  ROOT.kBlue, ROOT.kOrange+7, ROOT.kTeal-3,  ROOT.kBlack, ROOT.kYellow,  ROOT.kCyan, ROOT.kRed ] 

#lista_de_pesos =  [P_3, P_6,  P_8,  P_10, P_11]
#colors =  [ ROOT.kOrange+4, ROOT.kAzure+3,  ROOT.kTeal-3,  ROOT.kYellow,   ROOT.kRed ] 
...
with open(output_file_path3, "a") as output_file3:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} of the 4th most energetic light-quark jet; P_{T} (GeV/c); Number of events (Normalized to one)", 5,30, 250)
