...
with open(output_file_path, "a") as output_file:
    ...
    # Histogramas globais para todos os eventos
        hist1 = ROOT.TH1F("hist1", "Invariant mass of W[1];  M_{j_q j_q} (GeV); Number of events (Normalized to one)", 70, 60, 100)
        hist2 = ROOT.TH1F("hist2", "Invariant mass of W[2];  M_{j_q j_q} (GeV); Number of events (Normalized to one)", 70, 60, 100)
...
output_file_path_1 = os.path.join(output_dir, "mW1_nfill_norm.png")
...
canvas_2.Update()
# Salvando o histograma em um arquivo de imagem
output_file_path_2 = os.path.join(output_dir, "mW2_nfill_norm.png")
