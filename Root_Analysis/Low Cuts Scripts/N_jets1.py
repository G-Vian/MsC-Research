...
with open(output_file_path, "a") as output_file:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        hist_jet_number = ROOT.TH1F("hist_jet_number", "Number of jets per event; Number of Jets; Number of events (L = 200 fb^{-1})", 16, -1, 16)
        hist_b_number = ROOT.TH1F("hist_bjet_number", "Number of b-tagged jets per event;Number of b-quark jets;Number of events (L = 200 fb^{-1})", 13, -2, 12)
        hist_q_number = ROOT.TH1F("hist_qjet_number", "Number of light-quark jets per event; Number of light-quark jets; Number of events (L = 200 fb^{-1})", 14, -1, 14)
