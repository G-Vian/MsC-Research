...
output_dir = os.path.join(script_dir, "HTq")
...
with open(output_file_path, "a") as output_file:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        histogram_HT = ROOT.TH1F("hist_ht", "H_{T}(light quark jets) ; H_{T}(light quark jets) (GeV); Number of events (L = 200 fb^{-1})" , 20, 0, 2000)
...
output_file_path_HT = os.path.join(output_dir, "HT_q.png")
