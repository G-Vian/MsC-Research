...
lista_de_pesos = [P_1, P_2, P_3, P_6, P_5, P_4 , P_7, P_8, P_9, P_10 , P_12, P_13, P_11]
...
canvas_ETA.SetRightMargin(0.12)
...
with open(output_file_path2, "a") as output_file2:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        histogram_ETA = ROOT.TH1F("hist_pt", "#eta jb[2]; #eta ; Number of events (L = 200 fb^{-1})", 20, -5,5)
