...
with open(output_file_path3, "a") as output_file3:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        # Criando histogramas para PT e ETA dos jato b 
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} of the 3rd most energetic b-quark jet; P_{T} (GeV/c); Number of events (L = 200 fb^{-1})", 20,0, 300)
...
with open(output_file_path3, "a") as output_file3:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        # Criando histogramas para PT e ETA dos jato b 
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} of the 4th most energetic b-quark jet; P_{T} (GeV/c); Number of events (L = 200 fb^{-1})", 20,0, 500)
