...
with open(output_file_path, "a") as output_file:
    ...
    # Histogramas globais para todos os eventos
        hist1 = ROOT.TH1F("hist1", "Invariant mass of the most energetic W;  M_{j_{q} j_{q}} (GeV); Number of events (Normalized to one)", 70, 60, 100)
        hist2 = ROOT.TH1F("hist2", "Invariant mass of the 2nd most energetic W;  M_{j_{q} j_{q}} (GeV); Number of events (Normalized to one)", 70, 60, 100)
...
################################################################## #NOVO PADRÃO
    ...
    legend_PT.AddEntry(0, "", "")
    legend_PT.AddEntry(0, "", "")
    legend_PT.AddEntry(0, f"Entr.: {N_entries1[i]:.1f}, Mod. V: {modal_values_1[i]:.1f} GeV/c^{2} ", "")
    legend_PT.AddEntry(0, "", "")
    legend_PT.AddEntry(0, "", "")
    legend_PT.Draw()
    legend_PT.Draw()
...
################################################################## #NOVO PADRÃO
    ...
    legend_PT.AddEntry(0, "", "")
    legend_PT.AddEntry(0, "", "")
    legend_PT.AddEntry(0, f"Entr.: {N_entries2[i]:.1f}, Mod. V: {modal_values_2[i]:.1f} GeV/c^{2} ", "")
    legend_PT.AddEntry(0, "", "")
    legend_PT.AddEntry(0, "", "")
    legend_PT.Draw()
