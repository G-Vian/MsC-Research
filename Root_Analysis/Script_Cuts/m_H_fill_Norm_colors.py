...
output_dir = os.path.join(script_dir, "M_colors")
...
with open(output_file_path, "a") as output_file:
    ...
    # Histogramas globais para todos os eventos
        hist1 = ROOT.TH1F("hist1", "Invariant mass of the most energetic H;  M_{j_{b} j_{b}} (GeV); Number of events (Normalized to one)", 20, 80, 170)
        hist2 = ROOT.TH1F("hist2", "Invariant mass of the 2nd most energetic H;  M_{j_{b} j_{b}} (GeV); Number of events (Normalized to one)", 20, 80, 170)
