...
with open(output_file_path1, "a") as output_file1:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} of the most energetic light-quark jet; P_{T} (GeV/c); Number of events (L = 200 fb^{-1})", 70,0, 1800)
...
with open(output_file_path2, "a") as output_file2:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        # Criando histogramas para PT e ETA dos jato b 
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} of the 2nd most energetic light-quark jet; P_{T} (GeV/c); Number of events (L = 200 fb^{-1})", 70,0, 800)
...
#################################################################
    ...
    # Distribuindo uniformemente
    legend_PT = ROOT.TLegend(0.72, y1 - i * (y1 - y2) / n_entries, 0.92, y1 - (i + 1) * (y1 - y2) / n_entries)
...
with open(output_file_path3, "a") as output_file3:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        # Criando histogramas para PT e ETA dos jato b 
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} of the 3rd most energetic light-quark jet; P_{T} (GeV/c); Number of events (L = 200 fb^{-1})", 70,0, 800)
...
with open(output_file_path3, "a") as output_file3:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        # Criando histogramas para PT e ETA dos jato b 
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} of the 4th most energetic light-quark jet; P_{T} (GeV/c); Number of events (L = 200 fb^{-1})", 70,0, 500)
