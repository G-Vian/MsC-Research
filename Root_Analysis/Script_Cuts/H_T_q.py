...
with open(output_file_path, "a") as output_file:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        histogram_HT = ROOT.TH1F("hist_ht", "H_{T}(light quark jets) ; H_{T}(light quark jets) (GeV); Number of events (L = 200 fb^{-1})" , 80, 0, 2500)
...
#################################################################
    ...
    legend_PT = ROOT.TLegend(0.78, y1 - i * (y1 - y2) / n_entries, 0.92, y1 - (i + 1) * (y1 - y2) / n_entries)
...
################################################################## #NOVO PADRÃO
   ...
   # legend_PT.AddEntry(0, "", "")
   # legend_PT.AddEntry(0, "", "")
    legend_PT.AddEntry(0, f"N.: {N_entries1[i]:.1f}, Mod. V: {modal_values_1[i]:.1f} GeV", "")
    #legend_PT.AddEntry(0, "", "")
    #legend_PT.AddEntry(0, "", "")
    #legend_PT.AddEntry(0, "", "")
    legend_PT.AddEntry(0, "", "")
