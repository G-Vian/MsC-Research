...
output_dir = os.path.join(script_dir, "b_jets_colors")
...
with open(output_file_path1, "a") as output_file1:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} of the most energetic b-quark jet; P_{T} (GeV/c); Number of events (L = 200 fb^{-1})", 20,0, 1500)
...
#################################################################
    ...
    legend_PT.AddEntry(histogram_PT, f"  {os.path.basename(inputFiles[i]).replace('100.root', '')}", "f")
...
with open(output_file_path2, "a") as output_file2:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        chain = ROOT.TChain("Delphes")
        chain.Add(inputFile)
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} of the 2nd most energetic b-quark jet; P_{T} (GeV/c); Number of events (L = 200 fb^{-1})", 20,0, 1200)
...
with open(output_file_path3, "a") as output_file3:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        chain = ROOT.TChain("Delphes")
        chain.Add(inputFile)
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} of the 3rd most energetic b-quark jet; P_{T} (GeV/c); Number of events (L = 200 fb^{-1})", 20,0, 600)
...
with open(output_file_path4, "a") as output_file4:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        chain = ROOT.TChain("Delphes")
        chain.Add(inputFile)
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} of the 4th most energetic b-quark jet; P_{T} (GeV/c); Number of events (L = 200 fb^{-1})", 20,0, 300)
...
with open(output_file_path5, "a") as output_file5:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        chain = ROOT.TChain("Delphes")
        chain.Add(inputFile)
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} of the 5th most energetic b-quark jet; P_{T} (GeV/c); Number of events (L = 200 fb^{-1})", 20,0, 200)
...
with open(output_file_path6, "a") as output_file6:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        chain = ROOT.TChain("Delphes")
        chain.Add(inputFile)
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} of the 6th most energetic b-quark jet; P_{T} (GeV/c); Number of events (L = 200 fb^{-1})", 20,0, 120)
