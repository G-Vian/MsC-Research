...
with open(output_file_path, "a") as output_file:
    ...
    # Histogramas globais para todos os eventos
        hist1 = ROOT.TH1F("hist1", "Invariant mass of the most energetic Z;  M_{j_b j_b} (GeV); Number of events (Normalized to one)", 20, 60, 120)
        hist2 = ROOT.TH1F("hist2", "Invariant mass of the 2nd most energetic Z;  M_{j_b j_b} (GeV); Number of events (Normalized to one)", 20, 60, 120)
...
output_file_path_1 = os.path.join(output_dir, "mZ1_nfill_norm.png")
...
canvas_2.Update()
# Salvando o histograma em um arquivo de imagem
output_file_path_2 = os.path.join(output_dir, "mZ2_nfill_norm.png")
