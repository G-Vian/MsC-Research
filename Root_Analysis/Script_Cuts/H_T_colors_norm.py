...
output_dir = os.path.join(script_dir, "HT_colors")
...
with open(output_file_path, "a") as output_file:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        if histogram_HT.Integral() > 0:
            histogram_HT.Scale(1.0 / histogram_HT.Integral())
    ...
    # Calculando média e desvio padrão 
        ...
        n_entries1 = peso_atual*histogram_HT.GetEntries()
...
y_min = min_nonzero_bin_content * 0.9 if min_nonzero_bin_content != float('inf') else 0.0001
...
output_file_path_HT = os.path.join(output_dir, "HT_Norm.png")
