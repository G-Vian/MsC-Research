...
with open(output_file_path1, "a") as output_file1:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} of the most energetic b-quark jet; P_{T} (GeV/c); Number of events (L = 200 fb^{-1})", 70,0, 1800)
        histogram_ETA = ROOT.TH1F("hist_pt", "#eta jb[1]; #eta ; Number of events (L = 200 fb^{-1})", 70, -5,5)
    ...
    # Calculando média e desvio padrão 
        ...
        n_selected1 = events_passed_final_selection
        n_entries1 = peso_atual*n_selected1
        ...
        n_selected2 = events_passed_final_selection
        n_entries2 = peso_atual*n_selected2
        # Valor modal (bin com o máximo número de entradas)
        max_bin_content = 0
        modal_value2 = 0
...
# Formatar R2 em notação científica com tolerância a valores pequenos
...
canvas_PT.SetRightMargin(0.287)
...
canvas_ETA.SetRightMargin(0.24)
...
#################################################################
    ...
    legend_PT = ROOT.TLegend(0.72, y1 - i * (y1 - y2) / n_entries, 0.90, y1 - (i + 1) * (y1 - y2) / n_entries)
...
################################################################## #NOVO PADRÃO
    ...
    legend_PT.AddEntry(0, "", "")
    legend_PT.AddEntry(0, "", "")
    legend_PT.AddEntry(0, f"Mean: {mean_values_PT[i]:.1f} GeV/c, Std Dev: {std_dev_values_PT[i]:.1f} GeV/c", "")
    legend_PT.AddEntry(0, "", "")
    legend_PT.AddEntry(0, "", "")
    legend_PT.AddEntry(0, f"Min: {min_values1[i]:.1f} GeV/c, Max: {max_values1[i]:.1f}  GeV/c", "")
    legend_PT.AddEntry(0, "", "")
    legend_PT.AddEntry(0, "", "")
    legend_PT.AddEntry(0, f"N.: {N_entries1[i]:.1f}, Mod. V: {modal_values_1[i]:.1f} GeV/c", "")
    legend_PT.AddEntry(0, "", "")
    legend_PT.AddEntry(0, "", "")
    legend_PT.Draw()
...
#################################################################
    ...
    # Distribuindo uniformemente
    legend_PT = ROOT.TLegend(0.77, y1 - i * (y1 - y2) / n_entries, 0.90, y1 - (i + 1) * (y1 - y2) / n_entries)
...
################################################################## #NOVO PADRÃO
    ...
    legend_PT.AddEntry(0, "", "")
    legend_PT.AddEntry(0, "", "")
    legend_PT.AddEntry(0, f"N.: {N_entries2[i]:.1f}, Mod. V: {modal_values_2[i]:.1f}", "")
    legend_PT.AddEntry(0, "", "")
    legend_PT.AddEntry(0, "", "")
    legend_PT.Draw()
...
with open(output_file_path2, "a") as output_file2:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        chain = ROOT.TChain("Delphes")
        chain.Add(inputFile)
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} of the 2nd most energetic b-quark jet; P_{T} (GeV/c); Number of events (L = 200 fb^{-1})", 70,0, 1700)
        histogram_ETA = ROOT.TH1F("hist_pt", "#eta jb[2]; #eta ; Number of events (L = 200 fb^{-1})", 70, -5,5)
...
with open(output_file_path3, "a") as output_file3:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        chain = ROOT.TChain("Delphes")
        chain.Add(inputFile)
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} of the 3rd most energetic b-quark jet; P_{T} (GeV/c); Number of events (L = 200 fb^{-1})", 70,0, 1000)
        histogram_ETA = ROOT.TH1F("hist_pt", "#eta jb[3]; #eta ; Number of events (L = 200 fb^{-1})", 70, -5,5)
...
with open(output_file_path4, "a") as output_file4:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        chain = ROOT.TChain("Delphes")
        chain.Add(inputFile)
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} of the 4th most energetic b-quark jet; P_{T} (GeV/c); Number of events (L = 200 fb^{-1})", 70,0, 400)
        histogram_ETA = ROOT.TH1F("hist_pt", "#eta jb[4]; #eta ; Number of events (L = 200 fb^{-1})", 70, -5,5)
...
with open(output_file_path5, "a") as output_file5:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        chain = ROOT.TChain("Delphes")
        chain.Add(inputFile)
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} of the 5th most energetic b-quark jet; P_{T} (GeV/c); Number of events (L = 200 fb^{-1})", 70,0, 300)
        histogram_ETA = ROOT.TH1F("hist_pt", "#eta jb[5]; #eta ; Number of events (L = 200 fb^{-1})", 70, -5,5)
...
with open(output_file_path6, "a") as output_file6:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        chain = ROOT.TChain("Delphes")
        chain.Add(inputFile)
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} of the 6th most energetic b-quark jet; P_{T} (GeV/c); Number of events (L = 200 fb^{-1})", 70,0, 200)
        histogram_ETA = ROOT.TH1F("hist_pt", "#eta jb[6]; #eta ; Number of events (L = 200 fb^{-1})", 70, -5,5)
