...
with open(output_file_path, "a") as output_file:
    ...
    # Histogramas globais para todos os eventos
        hist1 = ROOT.TH1F("hist1", "Invariant mass of h[1] 300 GeV/c²;  M_{j_b j_b} (GeV); Number of events (Normalized to one)", 70, 0, 500)
        hist2 = ROOT.TH1F("hist2", "Invariant mass of h[2] 300 GeV/c²;  M_{j_b j_b} (GeV); Number of events (Normalized to one)", 70, 250, 350)
