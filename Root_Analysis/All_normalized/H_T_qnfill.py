...
output_dir = os.path.join(script_dir, "HT_q_nfill")
...
with open(output_file_path, "a") as output_file:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        total_events_hist = histogram_HT.GetEntries()
        ...
        output_file.write(f"Eventos que passaram a seleção final: {events_passed_final_selection}\n")
        output_file.write(f"Eventos que entraram no histograma: {total_events_hist}\n")
...
#    legend_PT = ROOT.TLegend(0.835, 1.02 - 0.12 * i, 0.92, 0.83 - 0.08 * i)
#    legend_PT.SetTextSize(0.01)
