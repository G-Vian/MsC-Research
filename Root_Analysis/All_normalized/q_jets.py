...
with open(output_file_path2, "a") as output_file2:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        # Criando histogramas para PT e ETA dos jato b 
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} jq[2]; P_{T} (GeV/c); Number of events (L = 200 fb^{-1})", 70,0, 1800)
...
with open(output_file_path3, "a") as output_file3:
    ...
    for i, inputFile in enumerate(inputFiles):
        ...
        # Criando histogramas para PT e ETA dos jato b 
        histogram_PT = ROOT.TH1F("hist_pt", "P_{T} jq[3]; P_{T} (GeV/c); Number of events (L = 200 fb^{-1})", 70,0, 1800)
